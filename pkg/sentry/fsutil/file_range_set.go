...
type FileRangeSet struct {
	segment.Set[uint64, uint64, FileRangeSetFunctions]
}

// FileRangeIterator is an iterator over FileRangeSet segments.
type FileRangeIterator = segment.Iterator[uint64, uint64, FileRangeSetFunctions]

// FileRangeGapIterator is an iterator over gaps in a FileRangeSet.
type FileRangeGapIterator = segment.GapIterator[uint64, uint64, FileRangeSetFunctions]
