...
type DirtySet struct {
	segment.Set[uint64, DirtyInfo, dirtySetFunctions]
}

// DirtyIterator is an iterator over DirtySet segments.
type DirtyIterator = segment.Iterator[uint64, DirtyInfo, dirtySetFunctions]

// DirtyGapIterator is an iterator over gaps in a DirtySet.
type DirtyGapIterator = segment.GapIterator[uint64, DirtyInfo, dirtySetFunctions]

// DirtyFlatSegment represents a DirtySet segment in a flat form.
type DirtyFlatSegment = segment.FlatSegment[uint64, DirtyInfo]
