...
//
// MappingSet maps offsets into a Mappable to mappings of those offsets.
//
// +stateify savable
type MappingSet struct {
	segment.Set[uint64, MappingsOfRange, mappingSetFunctions]
}

// MappingIterator is an iterator over MappingSet segments.
type MappingIterator = segment.Iterator[uint64, MappingsOfRange, mappingSetFunctions]

// MappingGapIterator is an iterator over gaps in a MappingSet.
type MappingGapIterator = segment.GapIterator[uint64, MappingsOfRange, mappingSetFunctions]
