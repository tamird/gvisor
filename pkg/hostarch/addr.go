...
type AddrRange = segment.Range[Addr]
...
// AddrRangeFunctions implements segment.Functions for AddrRange.
type AddrRangeFunctions AddrRange

// IsPageAligned returns true if ar.Start.IsPageAligned() and
// ar.End.IsPageAligned().
func (ar AddrRangeFunctions) IsPageAligned() bool {
...
func (ar AddrRangeFunctions) IsHugePageAligned() bool {
